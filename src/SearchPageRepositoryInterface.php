...
interface SearchPageRepositoryInterface {
   ...
   *
   * @return \Drupal\pleade\SearchPageInterface[]
   ...
   *
   * @return \Drupal\pleade\SearchPageInterface|bool
   ...
   *
   * @param \Drupal\pleade\SearchPageInterface $search_page
   ...
   *
   * @param \Drupal\pleade\SearchPageInterface[] $search_pages
